...
| Anthropic | `anthropic` | coding, model | claude, claude-code | 44 | net-coffee, fetched 2026-05-14; xiaolai, fetched 2026-05-14; v2fly, fetched 2026-05-14 |
...
| ByteDance AI | `bytedance-ai` | coding | trae, coze, marscode, cici | 14 | skywalkerji, fetched 2026-05-14 |
| Cerebras | `cerebras` | model | - | 1 | v2fly, fetched 2026-05-14 |
| Character.AI | `character-ai` | - | - | 1 | _handwritten_ |
| Chutes | `chutes` | model | - | 1 | _handwritten_ |
| Civitai | `civitai` | media | - | 1 | _handwritten_ |
| ClipDrop | `clipdrop` | media | - | 1 | _handwritten_ |
| Cloudflare AI | `cloudflare-ai` | model | workers-ai, ai-gateway | 1 | _handwritten_ |
| CodeRabbit | `coderabbit` | coding | - | 1 | _handwritten_ |
| Cohere | `cohere` | model | - | 2 | _handwritten_ |
| ComfyUI | `comfyui` | media | - | 2 | _handwritten_ |
| Continue | `continue` | coding | - | 1 | _handwritten_ |
| Copilot | `copilot` | coding | github-copilot, microsoft-copilot | 35 | blackmatrix7, fetched 2026-05-14; v2fly, fetched 2026-05-14 |
| CrewAI | `crewai` | coding | - | 1 | _handwritten_ |
| Cursor | `cursor` | coding | - | 4 | v2fly, fetched 2026-05-14 |
...
| Eigent | `eigent` | - | - | 1 | _handwritten_ |
| ElevenLabs | `elevenlabs` | media | eleven-labs | 2 | v2fly, fetched 2026-05-14 |
| Factory | `factory` | coding | - | 1 | _handwritten_ |
| Fireworks AI | `fireworks-ai` | model | - | 1 | _handwritten_ |
| Gamma | `gamma` | - | - | 1 | _handwritten_ |
| Genspark | `genspark` | - | - | 1 | _handwritten_ |
| Google AI | `google-ai` | coding, model | gemini, ai-studio, notebooklm, antigravity | 39 | blackmatrix7, fetched 2026-05-14; v2fly, fetched 2026-05-14 |
| Grammarly | `grammarly` | - | - | 1 | _handwritten_ |
| Groq | `groq` | model | - | 1 | v2fly, fetched 2026-05-14 |
| H2O.ai | `h2o-ai` | model | - | 1 | _handwritten_ |
| Hermes Agent | `hermes-agent` | - | - | 1 | _handwritten_ |
| HeyGen | `heygen` | media | - | 1 | _handwritten_ |
| Hugging Face | `huggingface` | model | hugging-face | 3 | v2fly, fetched 2026-05-14 |
| Ideogram | `ideogram` | media | - | 1 | _handwritten_ |
| Inflection / Pi | `inflection` | - | pi | 2 | _handwritten_ |
| Jasper | `jasper` | - | - | 1 | _handwritten_ |
| JetBrains AI | `jetbrains-ai` | coding | grazie, junie | 3 | v2fly, fetched 2026-05-14 |
| Kiro | `kiro` | coding | - | 3 | _handwritten_ |
| LangChain | `langchain` | coding | - | 1 | _handwritten_ |
| Leonardo AI | `leonardo-ai` | media | - | 1 | _handwritten_ |
| LMArena | `lmarena` | model | - | 1 | _handwritten_ |
| LM Studio | `lmstudio` | model | lm-studio | 1 | _handwritten_ |
...
| Manus | `manus` | coding | - | 2 | v2fly, fetched 2026-05-14 |
| Meta AI | `meta-ai` | - | llama | 3 | v2fly, fetched 2026-05-14 |
...
| OpenAI | `openai` | coding, model | chatgpt, codex | 43 | blackmatrix7, fetched 2026-05-14; v2fly, fetched 2026-05-14 |
...
| Perplexity | `perplexity` | - | - | 5 | v2fly, fetched 2026-05-14 |
| Phind | `phind` | - | - | 1 | _handwritten_ |
| Pika | `pika` | media | - | 1 | _handwritten_ |
| Poe | `poe` | - | - | 2 | v2fly, fetched 2026-05-14 |
| Recraft | `recraft` | media | - | 1 | _handwritten_ |
| Replicate | `replicate` | model | - | 2 | _handwritten_ |
| Replit | `replit` | coding | - | 5 | _handwritten_ |
| Runway | `runway` | media | - | 2 | _handwritten_ |
| Sourcegraph | `sourcegraph` | coding | cody, amp | 4 | _handwritten_ |
| Stability AI | `stability-ai` | media | stable-diffusion | 1 | _handwritten_ |
| Suno | `suno` | media | - | 2 | _handwritten_ |
| Synthesia | `synthesia` | media | - | 1 | _handwritten_ |
| Tabnine | `tabnine` | coding | - | 1 | _handwritten_ |
| Together AI | `together-ai` | model | - | 2 | _handwritten_ |
| Udio | `udio` | media | - | 1 | _handwritten_ |
| v0 | `v0` | coding | vercel-v0 | 2 | _handwritten_ |
| Windsurf | `windsurf` | coding | codeium | 4 | v2fly, fetched 2026-05-14 |
| xAI | `x-ai` | - | grok | 3 | v2fly, fetched 2026-05-14 |
| You.com | `you` | - | - | 1 | _handwritten_ |
| YouMind | `youmind` | - | - | 3 | _handwritten_ |
| Zed | `zed` | coding | - | 1 | _handwritten_ |
